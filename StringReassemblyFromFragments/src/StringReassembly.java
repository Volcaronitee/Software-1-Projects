...
/**
 * Utility class to support string re assembly from fragments.
 *
 * @author Allen Zheng
 *
 * @mathdefinitions <pre>
...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        String newStr = str1.substring(0, str1.length() - overlap) + str2;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
            ...
            for (String str2 : strSet) {
                if (!str1.equals(str2)) {
                    assert !str1.contains(
                            str2) : "Violation of: strSet contains subtring pairs";
                    assert !str2.contains(
                            str1) : "Violation of: strSet contains subtring pairs";
                }
            }
        }
        ...
        Set<String> rem = new Set1L<>();
        for (String line : strSet) {
            if (!line.equals(str) && str.contains(line)) {
                rem.add(line);
            }
        }
        strSet.remove(rem);
